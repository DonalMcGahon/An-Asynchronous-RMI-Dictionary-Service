...
public class DictControllerAdd extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        if("".equals(word) || "".equals(meaning)){
	        	...
	        	message = fs.addWordMeaning(word,meaning);
			}
		...
		// HTML thats responses telling user their word and description was added
